    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='articles.book')),
            ],
            options={
                'ordering': ['due_back'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_article', models.DateField(default='2023-01-11', verbose_name='Date create article')),
